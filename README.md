...
3.Download SDK   
3.1Download the [latest iOS SDK version](https://s3-us-west-1.amazonaws.com/appodeal-ios/0.4.7-1/Appodeal.zip) and extract Appodeal iOS SDK.   
...
- **[Appodeal SDK.zip](https://s3-us-west-1.amazonaws.com/appodeal-ios/0.4.7-1/Appodeal.zip)**

The current version of the SDK is 0.4.7.1
