...
+ (void)initializeWithApiKey:(NSString *)apiKey autocache:(BOOL)autocache;

+ (void)initializeWithApiKey:(NSString *)apiKey types:(AppodealAdType)types;
+ (void)initializeWithApiKey:(NSString *)apiKey types:(AppodealAdType)types autocache:(BOOL)autocache;
...
+ (void)showAd:(AppodealShowStyle)style rootViewController:(UIViewController *)rootViewController;
+ (void)hideBanner;
